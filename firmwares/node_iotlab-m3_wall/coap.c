...
#define APPLICATION_NAME "Light Sensor (wall)"
...
extern void _read_illuminance(phydat_t * illuminance);
                                  ...
                                  uint8_t id_hi, uint8_t id_lo)
{
    ...
    sprintf(illuminance, "%ilx", (int)ill.val);
                          ...
                          uint8_t id_hi, uint8_t id_lo)
{
    ...
    if ((inpkt->payload.len == 1) &&
        ...
        gpio_write(LED1_PIN, val - 1);
        gpio_write(LED2_PIN, val - 1);
    }
    else {
